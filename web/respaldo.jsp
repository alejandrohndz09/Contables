<%-- 
    Document   : respaldo
    Created on : 22/09/2019, 01:15:05 PM
    Author     : Xom
--%>
                    ...
                    <div class="tab-pane fade show active bg-white py-2">
                        ...
                        <div class="container">
                            <div class="text-center text-white bg-info py-2 font-weight-bold">
                                <h1 class="font-weight-bold">Crear respaldo de la información</h1>
                            </div>
                        </div>
                        <div class="container">
                            <div class="bg-white">
                                <div class="row px-5 py-5">
                                    ...
                                    <div class="col-md-6 bg-light">
                                        ...
                                        <form id="formbackup" name="formbackup" action="#" method="post" class="py-3">
                                            <div class="row px-5">
                                                <div class="form-group col-md-12">
                                                    <div class="input-group mb-1"> 
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" id="basic-addo1"><i class="fa fa-venus"></i></span>
                                                        </div>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <div class="input-group mb-1"> 
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" id="basic-addo1"><i class="fa fa-venus-mars"></i></span>
                                                        </div>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <div class="input-group mb-1"> 
                                                        ...
                                                        <input type="text" id="database" name="database" class="form-control" placeholder="Nombre de la base de datos">
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <div class="input-group mb-1"> 
                                                ...
                                                <div class="form-group col-md-12">
                                                    <div class="input-group mb-1"> 
                                                        ...
                                                        <input type="password" id="pass" name="pass" class="form-control" placeholder="Contraseña del usuario">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group col-md-12 text-center">
                                                <button type="submit" class="btn btn-success"><span class="fa fa-database"></span> Crear respaldo</button>
                                                <button type="button" class="btn btn-danger" onclick="empty()"><span class="fa fa-trash-o"></span> Cancelar</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-md-3"></div>
